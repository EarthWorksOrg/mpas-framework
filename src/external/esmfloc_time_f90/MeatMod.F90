...
SUBROUTINE fraction_to_stringi8( numerator, denominator, frac_str )
  IMPLICIT NONE
  INTEGER(ESMFloc_KIND_I8), INTENT(IN) :: numerator
  INTEGER(ESMFloc_KIND_I8), INTENT(IN) :: denominator
...
SUBROUTINE fraction_to_string( numerator, denominator, frac_str )
  ...
  CHARACTER (LEN=*), INTENT(OUT) :: frac_str
  ! locals
  INTEGER(ESMFloc_KIND_I8) :: numerator_i8, denominator_i8
  numerator_i8 = INT( numerator, ESMFloc_KIND_I8 )
  denominator_i8 = INT( denominator, ESMFloc_KIND_I8 )
